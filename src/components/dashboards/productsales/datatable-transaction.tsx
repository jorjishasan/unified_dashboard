...
const TransactionDatatable = ({ data }: { data: Item[] }) => {
  ...
  return (
    <div className='w-full'>
            ...
            {table.getHeaderGroups().map(headerGroup => (
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map(header => {
                  return (
                    <TableHead key={header.id} className='h-14 px-4 text-muted-foreground'>
      ...
      <div className='flex flex-row items-center justify-between gap-3 px-6 py-4 max-sm:flex-col md:max-lg:flex-col'>
