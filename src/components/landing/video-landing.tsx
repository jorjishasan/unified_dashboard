...
export const VideoLanding = () => {
  ...
  return (
    <div className="relative w-full bg-black min-h-screen">
      ...
      {/* Main Content Wrapper - Scrolls over the video */}
        ...
        <div className="relative min-h-screen w-full flex flex-col">
          ...
          <div className="flex-1 -mt-8 lg:-mt-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-8 pt-20 sm:pt-0">
            ...
            <Link 
              ...
              className="group relative bg-white text-black px-8 py-3.5 sm:py-4 rounded-full flex items-center gap-1 transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_-5px_rgba(255,255,255,0.6)]"
            >
              <span 
