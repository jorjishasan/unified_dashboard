...
const templates: Template[] = [
  {
    title: "Landing Pages",
    description: "Engaging landing pages designed to convert, tailored for any business or personal project.",
  ...
  },
  {
    ...
    description: "Ready-to-use frontend templates for eCommerce, agencies, LMS, and more - all-in-one solutions.",
...
export function ShowcaseSection() {
  return (
    <section className="py-32 bg-white w-full relative z-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px] border-l border-r border-dashed border-slate-200">
        <div className="text-center mb-24 space-y-6">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-slate-900" style={{ fontFamily: 'var(--font-instrument-serif)' }}>
            Explore 10+ Premium <br className="hidden md:block" />
            <span className="relative inline-block">
              <span className="relative z-10">Shadcn UI Templates</span>
